        ...
        try:
            ...
            if hasattr(self, 'jito_service') and self.jito_service:
                try:
                    ...
                    # Build and sign transaction for Jito
                    ...
                    if signed_tx:
                        ...
                        if signature:
                            logger.info(f"✅ Jito MEV Direct Copy SUCCESS: {signature}")
                            return signature
                        else:
